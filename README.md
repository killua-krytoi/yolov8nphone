...
Doordat raspberry pi 4 is niet zo sterk, ik moest code optimiseren. Op deze moment code maakt vaste [resolutie van 320x320p](https://github.com/killua-krytoi/yolov8nphone/blob/main/data/config.py#L21-#L23), en stuurt naar ai alleen maar [elke tiende frame.](https://github.com/killua-krytoi/yolov8nphone/blob/main/main.py#L16-#L18)
